...
--·œÌ‰« ÃœÊ· ··ÿ·«» ›ÌÂ œ—Ã« Â„ «›’· «·ÿ·«» «·„„ «“Ì‰ ›Ì ÃœÊ· ÃœÌœ ·ÊÕœÂ Ê«÷› «·—«”»Ì‰ ›Ì ÃœÊ· „ÊÃÊœ
...
Order by MonthlySalary Desc; -- „⁄ «· ﬂ—«—

Select distinct Top 3 MonthlySalary From Employees
Order by MonthlySalary Desc; -- »œÊ‰  ﬂ—«—
...
--If you donít want to use HAVING, you can use WHERE with GROUP BY like this: --
Select * From(
	SELECT 
		DepartmentID,
		TotalCount = Count(ID),
...
--‘—Õ ›«∆œÂ «·«‰œﬂ” 
--Ì÷«⁄› ”—⁄Â «” —Ã«⁄ «·»Ì«‰«  ÊÌﬁ·· ”—⁄Â «· ⁄œÌ·
-- ·ﬁ«∆Ì« «·»—«Ì„Ì ﬂÌ ⁄·ÌÂ «”—⁄ «‰ﬂ” ÊÂÊ(PRIMARY KEY CLUSTERED )
--ÕÌÀ Ì„ﬂ‰ «· Õﬂ„ »«· — Ì»  ’«⁄œÌ« «Ê  ‰«“·Ì«
